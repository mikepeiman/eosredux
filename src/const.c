...
{"Man",
									...
									{"Cardinal of the Ether",
									 "Cardinal of the Ether"},
									
									{"Cardinal of the Heavens",
									 "Cardinal of the Heavens"},
...
/*100 */
									...
									{"Demi God of Divinity",
									 "Demi Goddess of Divinity"},
...
{
"charm person", 
{24, L_APP, L_APP, L_APP, L_APP, 50, 29, L_APP, L_APP,
			 19, 
L_APP, L_APP, L_APP, L_APP, L_APP, L_APP},
...
{
"detect hidden", 
{L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 39, L_APP,
			   L_APP, 23, 
L_APP, L_APP, L_APP, L_APP, L_APP,
			   L_APP}, 
spell_detect_hidden, TAR_CHAR_SELF,
       POS_STANDING, 
NULL, 5, 12, 
"",
...
"$n's vision returns to normal.", TRUE,
    SLOT(11) 
}, 
 
{
"detect poison", 
{L_APP, 11, 17, L_APP, L_APP, 11, 27,
					 11, L_APP, L_APP, 
L_APP, L_APP, L_APP,
					 L_APP, L_APP, L_APP},
...
NULL, 12, 12, 
"faerie fog", "!Faerie Fog!", "", FALSE,
SLOT(0) 
}, 
 
{
"fireball", 
{21, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
			 L_APP, L_APP, 
L_APP, L_APP, L_APP, L_APP, L_APP,
			 L_APP}, 
spell_fireball, TAR_CHAR_OFFENSIVE,
	  POS_FIGHTING, 
NULL, 15, 12, 
"&Rfireball&X", "!Fireball!", "", FALSE,
	  SLOT(0) 
}, 
 
{
"fireshield", 
{65, 23, L_APP, L_APP, L_APP, 34, 51,
					   L_APP, L_APP, L_APP, 
L_APP, L_APP,
					   L_APP, L_APP, L_APP, L_APP},
...
{
"icestorm", 
{31, L_APP, L_APP, L_APP, L_APP, L_APP,
				      L_APP, L_APP, L_APP, L_APP, 
L_APP, L_APP,
				      L_APP, L_APP, L_APP, L_APP},
...
NULL,
		       25, 8, 
"&Cicy blast&X", "!ICESTORM!", "", FALSE,
		       SLOT(0) 
}, 
 
{
"identify", 
{10, 10, 25, L_APP, 13, 10,
						      17, 17, L_APP, 16, 
11,
						      L_APP, L_APP, L_APP,
						      L_APP, L_APP},
				       
spell_identify, TAR_OBJ_INV,
				       POS_STANDING, 
NULL, 12, 24, 
"",
...
{
"invis", 
{24, L_APP, L_APP, L_APP, L_APP, 30, 24, L_APP,
			     L_APP, 26, 
L_APP, L_APP, L_APP, L_APP, L_APP,
			     L_APP}, 
spell_invis, TAR_CHAR_DEFENSIVE,
		 POS_STANDING, 
&gsn_invis, 5, 12, 
"",
...
NULL, 15, 12, 
"&Blightning bolt&X", "!Lightning Bolt!", "", FALSE,
SLOT(0) 
}, 
...
NULL, 15, 12, 
"&Pmag&pic mis&Psile", "!Magic Missile!", "", FALSE,
SLOT(0) 
}, 
...
spell_protection, TAR_CHAR_SELF,
				       POS_STANDING, 
NULL, 5, 12, 
"",
...
&gsn_sleep, 15, 12, 
"", "You feel less tired.", 
"$n looks much more refreshed.", TRUE,
SLOT(30) 
}, 
...
L_APP,
       L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_stone_skin, TAR_CHAR_SELF,
POS_STANDING, 
NULL, 12, 18, 
"", 
...
L_APP,
 L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_fire_breath, TAR_CHAR_OFFENSIVE,
POS_FIGHTING, 
NULL, 50, 12, 
"&Rblast of &rflame&X", "!Fire Breath!", "", FALSE,
SLOT(0) 
}, 
 
{
"frost breath", 
{61, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
				  L_APP, L_APP, L_APP, 
L_APP, L_APP, L_APP,
				  L_APP, L_APP, L_APP}, 
spell_frost_breath,
...
L_APP,
 L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_gas_breath, TAR_IGNORE,
POS_FIGHTING, 
NULL, 50, 12, 
"&zblast of &wgas", "!Gas Breath!", "", FALSE,
SLOT(0) 
}, 
 
{
"lightning breath", 
{62, L_APP, L_APP, L_APP, L_APP, L_APP,
				      L_APP, L_APP, L_APP, L_APP, 
L_APP, L_APP,
				      L_APP, L_APP, L_APP, L_APP},
...
NULL,
	       50, 12, 
"&cblast of &Blightning", "!Lightning Breath!", "",
	       FALSE, SLOT(0) 
}, 
/*
...
{
"flury", 
{L_APP, L_APP, L_APP, 44, L_APP, L_APP, L_APP,
			      L_APP, L_APP, L_APP, 
L_APP, L_APP, L_APP, L_APP, L_APP, L_APP},
...
"kick", 
{L_APP, L_APP, 50, 10,
						     L_APP, L_APP, 23, L_APP, L_APP, L_APP,
...
"peek", 
{L_APP,
								    L_APP, 23, L_APP, L_APP,
								    L_APP, L_APP, L_APP, 29,
								    L_APP, 
L_APP, L_APP,
								    L_APP, L_APP, L_APP,
								    L_APP}, 
...
{L_APP, L_APP, 5, L_APP, L_APP,
					       L_APP, L_APP, L_APP, 9, L_APP, 
L_APP, L_APP,
					       L_APP, L_APP, L_APP, L_APP}, 
spell_null,
	      TAR_IGNORE, POS_STANDING, 
...
{
"punch", 
{L_APP, L_APP, L_APP, 31, L_APP, L_APP,
				     L_APP, L_APP, L_APP, L_APP, 
...
"kindey punch", "!kidney punch!", "", FALSE,
						 SLOT(0) 
}, 
...
{L_APP, L_APP, L_APP, 50, L_APP, L_APP,
					 L_APP, L_APP, L_APP, L_APP, 
L_APP, L_APP, L_APP,
					 L_APP, L_APP, L_APP}, 
spell_null,
...
"roundhouse",
"!roundhouse punch!", "", FALSE, SLOT(0) 
}, 
 
{
"uppercut punch", 
{L_APP, L_APP, L_APP, 55,
							L_APP, L_APP, L_APP, L_APP, L_APP,
							L_APP, 
L_APP, L_APP, L_APP, L_APP,
							L_APP, L_APP}, 
...
"general purpose ammo", "!General Purpose Ammo!", "", FALSE,
	 SLOT(0) 
}, 
...
spell_high_explosive, TAR_CHAR_OFFENSIVE,
			 POS_FIGHTING, 
NULL, 0, 12, 
"high explosive ammo",
			 "!High Explosive Ammo!", "", FALSE, SLOT(0) 
}, 
	    ...
	    {
"adrenaline control", 
		 {L_APP, L_APP, L_APP, L_APP, 17, L_APP, L_APP, L_APP,
		      L_APP, L_APP, 
...
"$n has calmed down.", FALSE,
	  SLOT(36) 
}, 
 
{
"agitation", 
{L_APP, L_APP, L_APP, L_APP, 6, L_APP,
					   L_APP, L_APP, L_APP, L_APP, 
L_APP,
					   L_APP, L_APP, L_APP, L_APP, L_APP},
...
NULL, 5, 12, 
"ballistic attack", "!Ballistic Attack!", "", FALSE,
SLOT(0) 
}, 
...
{
"combat mind", 
{L_APP, L_APP, L_APP, L_APP, 15, L_APP,
				     L_APP, L_APP, L_APP, L_APP, 
L_APP, L_APP,
				     L_APP, L_APP, L_APP, L_APP},
...
NULL, 15, 12, 
"tongue of &Rflame&X", "!Control Flames!", "", FALSE,
SLOT(0) 
}, 
...
{L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
			    L_APP, L_APP, 68, 
70, L_APP, L_APP, L_APP, L_APP,
			    L_APP}, 
spell_death_field, TAR_IGNORE,
	  POS_FIGHTING, 
NULL, 200, 18, 
"&zfield of death&X", "!Death Field!",
	  "", FALSE, SLOT(0) 
}, 
...
"detonate", 
{L_APP, L_APP, L_APP, L_APP,
						    27, L_APP, L_APP, L_APP,
						    L_APP, L_APP, 
L_APP, L_APP,
						    L_APP, L_APP, L_APP, L_APP},
				     
spell_detonate, TAR_CHAR_OFFENSIVE,
				     POS_FIGHTING, 
NULL, 35, 24,
				     
"&zdet&Rona&rtion", "!Detonate!", "",
				     FALSE, SLOT(0) 
}, 
...
{
"domination", 
{L_APP, L_APP, L_APP, L_APP, 16, L_APP,
					  L_APP, L_APP, L_APP, L_APP, 
L_APP,
					  L_APP, L_APP, L_APP, L_APP, L_APP},
...
{
"heighten senses", 
{L_APP, L_APP, 10, L_APP, 3, L_APP,
					L_APP, L_APP, L_APP, L_APP, 
L_APP, 23,
					14, L_APP, L_APP, L_APP}, 
spell_null,
		  TAR_CHAR_SELF, POS_STANDING, 
&gsn_heighten, 0, 0, 
"",
...
{
"inflict pain", 
{L_APP, L_APP, L_APP, L_APP, 5, L_APP, L_APP,
			      L_APP, L_APP, L_APP, 
9, L_APP, L_APP, L_APP,
			      L_APP, L_APP}, 
spell_inflict_pain,
...
{
"mental barrier", 
{L_APP, L_APP, L_APP, L_APP, 6, L_APP, L_APP,
			       L_APP, L_APP, L_APP, 
L_APP, L_APP, 48, L_APP,
			       L_APP, L_APP}, 
...
NULL, 18, 12, 
"&wprojected force&X", "!Project Force!", "", FALSE,
SLOT(0) 
}, 
...
spell_psychic_crush, TAR_CHAR_OFFENSIVE,
				 POS_FIGHTING, 
NULL, 15, 18,
				 
"&wpsychic crush&X", "!Psychic Crush!", "",
				 FALSE, SLOT(0) 
}, 
...
{
"share strength", 
{L_APP, L_APP, L_APP, L_APP, 11, L_APP, L_APP, L_APP,
			   L_APP, L_APP, 
L_APP, L_APP, L_APP, L_APP, L_APP,
			   L_APP}, 
spell_share_strength, TAR_CHAR_DEFENSIVE,
      POS_STANDING, 
NULL, 8, 12, 
"",
...
{
"ultrablast", 
{L_APP, L_APP, L_APP, L_APP, 25, L_APP, L_APP, L_APP,
			  L_APP, L_APP, 
L_APP, L_APP, L_APP, L_APP, L_APP,
			  L_APP}, 
...
spell_mental_block, TAR_CHAR_DEFENSIVE,
				    POS_STANDING, 
NULL, 25, 8, 
"",
...
L_APP, L_APP, L_APP, L_APP, L_APP, L_APP}, 
gspell_flamesphere,
     TAR_GROUP_OFFENSIVE, POS_STANDING, 
NULL, 14, 20, 
"flamesphere",
     "!Flamesphere!", "", TRUE, SLOT(58) 
}, 
...
L_APP,
       L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_detect_good, TAR_CHAR_SELF,
     POS_STANDING, 
NULL, 5, 12, 
...
"The peace within $n disappears.", FALSE,
     SLOT(0) 
}, 
...
{
"gouge", 
{L_APP, L_APP, 20, L_APP, L_APP, L_APP, L_APP,
				  L_APP, L_APP, L_APP, 
L_APP, L_APP, L_APP,
				  L_APP, L_APP, L_APP}, 
spell_null, TAR_IGNORE,
...
{
"scribe", 
{60, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
				  L_APP, L_APP, L_APP, 
...
{
"stun", 
{L_APP, L_APP, L_APP, 43, L_APP, L_APP, L_APP,
				L_APP, L_APP, L_APP, 
L_APP, L_APP, L_APP,
				L_APP, L_APP, L_APP}, 
spell_null, TAR_IGNORE,
...
L_APP,
       L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_entangle, TAR_CHAR_OFFENSIVE,
     POS_FIGHTING, 
NULL, 25, 14, 
...
61,
       L_APP, L_APP, L_APP, L_APP, L_APP}, 
spell_darkbless, TAR_CHAR_DEFENSIVE,
     POS_STANDING, 
NULL, 50, 24, 
"",
...
L_APP, L_APP,
L_APP, L_APP, L_APP, L_APP}, 
spell_dancing_lights, TAR_CHAR_OFFENSIVE,
POS_FIGHTING, 
NULL, 50, 12, 
"dancing lights",
...
L_APP, L_APP,
L_APP, L_APP, L_APP, L_APP}, 
spell_molecular_unbind, TAR_CHAR_OFFENSIVE,
POS_FIGHTING, 
NULL, 100, 32, 
...
spell_stench_of_decay, TAR_CHAR_OFFENSIVE,
				  POS_FIGHTING, 
NULL, 15, 12,
				  
"&zstench of decay&X", "!Stench of Decay!",
				  "", FALSE, SLOT(0) 
}, 
...
{L_APP, L_APP, 70, 79, L_APP,
					      L_APP, L_APP, L_APP, L_APP, L_APP, 
L_APP, 70,
					      76, L_APP, L_APP, L_APP}, 
spell_null,
	       TAR_CHAR_SELF, POS_STANDING, 
&gsn_reflex, 0, 36, 
"",
...
{
"missiles", 
{L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
			3, L_APP, 
L_APP, L_APP, L_APP, L_APP, L_APP, L_APP},
...
{L_APP, L_APP, L_APP, L_APP,
						     L_APP, L_APP, L_APP, L_APP, 3, L_APP,
						     
L_APP, L_APP, L_APP, L_APP, L_APP,
						     L_APP}, 
spell_ventriloquate, TAR_IGNORE,
		       POS_STANDING, 
NULL, 5, 12, 
"", "!Ventriloquate!", "", FALSE,
		       SLOT(0) 
...
spell_shocking_grasp, TAR_CHAR_OFFENSIVE,
						    POS_FIGHTING, 
NULL, 15, 12,
...
spell_charm_person, TAR_CHAR_OFFENSIVE,
						      POS_STANDING, 
&gsn_charm_person, 5, 12,
						      
"", "You feel more self-confident.",
						      
"$n looks more confident.", TRUE,
						      SLOT(92) 
}, 
...
{L_APP, L_APP, L_APP,
						      L_APP, L_APP, L_APP, L_APP, L_APP, 7,
						      L_APP, 
L_APP, L_APP, L_APP, L_APP,
						      L_APP, L_APP}, 
spell_giant_strength,
...
"seeing", 
{L_APP, L_APP, L_APP, L_APP,
					       L_APP, L_APP, L_APP, L_APP, 28, L_APP, 
L_APP,
					       L_APP, L_APP, L_APP, L_APP, L_APP},
